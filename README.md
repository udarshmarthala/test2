...
Important: deploy the contents of `dist/` (generated by `npm run build`), not the raw source files.
...
- Push `dist/` to your Pages publishing branch/folder.
- In GitHub Pages settings, set source to that published output.

If you publish source files directly, styles/scripts may fail to load on mobile and show an unstyled page.
